        ...
        <div class="relative">
            ...
            >
                <button
                    ...
                    class="flex themeColor-center hover:bg-gray-100 dark:hover:bg-gray-800 w-full text-left cursor-pointer py-2 px-3 focus:outline-none focus:ring rounded truncate whitespace-nowrap text-gray-500 active:text-gray-600 dark:text-gray-500 dark:hover:text-gray-400 dark:active:text-gray-600"
                >
...
const setOption = (selectedOption) => {
    ...
    if (option.value === 'system') {
        ...
        option.value === 'dark' ? setTheme('dark') : setTheme('light')
    }
}
...
const updateDarkClass = (newTheme) => {
    if (newTheme === 'dark') {
